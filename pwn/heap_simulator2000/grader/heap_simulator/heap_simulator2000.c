...
#else
#define FLAG_2000 "ok now try with the real one"
...
void you_win(int s) {
    writeend("Congratulations! The key is " FLAG_2000 "\n");
}
...
void handle_request(void) {
  ...
  signal(SIGSEGV, you_win);
  sendstr(" **** WELCOME TO THE HEAP SIMULATOR 2000! ****\n");
  while (1) {
